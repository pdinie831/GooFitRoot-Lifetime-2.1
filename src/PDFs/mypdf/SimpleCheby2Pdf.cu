...
__device__ fptype device_SimpleCheby2 (fptype *evt, fptype *p, unsigned int *indices) {
...
__device__ device_function_ptr ptr_to_SimpleCheby2 = device_SimpleCheby2; 

__host__ SimpleCheby2Pdf::SimpleCheby2Pdf (std::string n, Observable _x, Variable p0, Variable p1,Variable xmin, Variable xmax ) 
  : GooPdf(n, _x) 
{
