...
__host__ PolyEffiPdf::PolyEffiPdf (string n, Observable* _x, vector<Variable*> weights, Variable* x0, unsigned int lowestDegree) 
  : GooPdf(_x, n) 
  , center(x0)
{
...
__host__ PolyEffiPdf::PolyEffiPdf (string n, vector<Observable*> obses, vector<Variable*> coeffs, vector<Variable*> offsets, unsigned int maxDegree) 
  : GooPdf(0, n) 
{
