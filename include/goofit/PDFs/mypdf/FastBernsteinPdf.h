...
class FastBernsteinPdf : public GooPdf {
  public:
    FastBernsteinPdf(std::string n, Observable _x, std::vector<Variable> weights,std::vector<Variable> limits, unsigned int maxDegree = 0);
//     FastBernsteinPdf(
//         std::string n, Observable _x, std::vector<Variable> weights, Variable x0, unsigned int lowestDegree = 0);
     FastBernsteinPdf(std::string n,
